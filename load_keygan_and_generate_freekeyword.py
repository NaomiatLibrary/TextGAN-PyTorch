...
cfg.dataset = 'emoint' #param change here!
cfg.vocab_size = 0
...
cfg.samples_num = 64 #change here!
cfg.batch_size = 64
cfg.max_seq_len = 47 #param change here! oracle: 20, coco: 37, emnlp: 51, amazon_app_book: 40
cfg.gen_lr = 0.01
cfg.gen_adv_lr = 1e-4
cfg.dis_lr = 1e-4
cfg.pre_log_step = 10
...
cfg.mem_slots = 1
cfg.num_heads = 2
cfg.head_size = 512 #param change here!
#dataset = ['oracle', 'mr15', 'amazon_app_book', 'oracle', 'image_coco', 'emnlp_news', 'haiku_wakati','aozora_moriougai','mr15', "emnlp_news_mini","emoint"]
#head_size = [512, 512, 512, 256, 256, 256, 256, 512, 256, 256,512]
...
if __name__ == '__main__':
    ...
    eval_samples = gen_model.sample_from_freekeyword(keywords,cfg.samples_num,cfg.batch_size,learned_word2vec_filename=learned_word2vec_filename)
    gen_data = KeyGenDataIter(eval_samples)
    gen_tokens = tensor_to_tokens(eval_samples, idx2word_dict)
    gen_tokens_s = tensor_to_tokens(gen_model.sample_from_freekeyword(keywords,200, 200,learned_word2vec_filename=learned_word2vec_filename),idx2word_dict)
    # Reset metrics
