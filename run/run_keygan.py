...
# ===Oracle or Real===
if_real_data = [int(False), int(True), int(True), int(False), int(True), int(True),int(True),int(True), int(True),int(True)] #change here!
...
vocab_size = [5000, 0, 0, 5000, 0, 0, 0, 0, 0,0] #change here!
...
eval_type = 'Ra'
temp_adpt = 'exp'
temperature = [1, 100, 100, 1, 100, 100, 100, 100, 100,100] #change here!
d_out_mean = int(True)
lambda_fq = 1.0
lambda_fd = 0.001
eval_b_num = 8
